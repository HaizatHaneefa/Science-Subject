...
public class Y4FractionsGame : MonoBehaviour
{
    [SerializeField] private QuestionsHolderFractions data;
    [SerializeField] private SpawnTrackFractionsGame spawntrack;
    ...
    void LookForQuestion()
    {
        ...
        else if (diff != index)
        {
            ...
            if (index == 0)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q1.ans4.ToString();
            ...
            else if (index == 1)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q2.ans4.ToString();
            ...
            else if (index == 2)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q3.ans4.ToString();
            ...
            else if (index == 3)
            {
                ...
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q4.ans4.ToString();
            ...
            else if (index == 4)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q5.ans4.ToString();
            ...
            else if (index == 5)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q6.ans4.ToString();
            ...
            else if (index == 6)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q7.ans4.ToString();
            ...
            else if (index == 7)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q8.ans4.ToString();
            ...
            else if (index == 8)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q9.ans4.ToString();
            ...
            else if (index == 9)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q10.ans4.ToString();
            ...
            else if (index == 10)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q11.ans4.ToString();
            ...
            else if (index == 11)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q12.ans4.ToString();
            ...
            else if (index == 12)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q13.ans4.ToString();
            ...
            else if (index == 13)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q14.ans4.ToString();
            ...
            else if (index == 14)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q15.ans4.ToString();
            ...
            else if (index == 15)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q16.ans4.ToString();
            ...
            else if (index == 16)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q17.ans4.ToString();
            ...
            else if (index == 17)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q18.ans4.ToString();
            ...
            else if (index == 18)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q19.ans4.ToString();
            ...
            else if (index == 19)
            {
                ...
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q20.ans4.ToString();

                cur = data.q20.num;
            }
            else if (index == 20)
            {
                questionText.text = data.q21.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q21.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q21.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q21.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q21.ans4.ToString();

                cur = data.q21.num;
            }
            else if (index == 21)
            {
                questionText.text = data.q22.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q22.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q22.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q22.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q22.ans4.ToString();

                cur = data.q22.num;
            }
            else if (index == 22)
            {
                questionText.text = data.q23.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q23.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q23.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q23.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q23.ans4.ToString();
            ...
            {
                questionText.text = data.q24.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q24.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q24.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q24.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q24.ans4.ToString();

                cur = data.q24.num;
            }
            else if (index == 25)
            {
                questionText.text = data.q25.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q25.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q25.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q25.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q25.ans4.ToString();

                cur = data.q25.num;
            }
            else if (index == 26)
            {
                questionText.text = data.q26.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q26.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q26.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q26.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q26.ans4.ToString();

                cur = data.q26.num;
            }
            else if (index == 27)
            {
                questionText.text = data.q27.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q27.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q27.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q27.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q27.ans4.ToString();

                cur = data.q27.num;
            }
            else if (index == 28)
            {
                questionText.text = data.q28.question.ToString();

                answerbutton[0].transform.parent.GetComponent<Animation>().Play("Y5 - RaceQuestion");

                answerbutton[0].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q28.ans1.ToString();
                answerbutton[1].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q28.ans2.ToString();
                answerbutton[2].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q28.ans3.ToString();
                answerbutton[3].transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = data.q28.ans4.ToString();
